...
const App = () => {
  ...
  return (
    <div className="min-h-screen font-sans p-4 md:p-8" style={{ backgroundColor: colors.bg, color: colors.text }}>
      {/* Header */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fadeIn">
            {methods.map((m, i) => (
              ...
              >
                ...
                <p className="text-sm mb-6 flex-grow" style={{ color: colors.textDim }}>
                  {m.desc}
                </p>
